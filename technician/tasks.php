...
<head>
    ...
    <title>Tasks | Technician Dashboard</title>
...
<body id="engineerTasksPage">
                        ...
                        <form id="assignTaskForm" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="projectSelect" required>
                                    ...
                                    <?php
                                    // Get projects where the technician is assigned
                                    try {
                                        $stmt = $pdo->prepare("
                                            SELECT DISTINCT 
                                                p.project_id, 
                                        ...
                                        error_log("Error in technician/tasks.php: " . $e->getMessage());
    ...
    function handleCheckIn() {
        ...
        fetch('../technician/api/check_in.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
