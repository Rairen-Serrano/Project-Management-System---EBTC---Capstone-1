...
<header class="technician-header">
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid px-4">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#technicianNavbarContent">
                <i class="fas fa-bars text-white"></i>
            </button>

            <div class="collapse navbar-collapse" id="technicianNavbarContent">
...
<!-- Sidebar -->
<nav class="technician-sidebar">
    <div class="technician-sidebar-menu">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sidebar = document.querySelector('.technician-sidebar');
    const mainContent = document.querySelector('.technician-main-content');
