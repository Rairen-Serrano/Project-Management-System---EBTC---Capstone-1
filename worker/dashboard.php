                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Install Electrical Wiring</td>
                                        ...
                                        <tr>
                                            <td>Setup Network Infrastructure</td>
                                            <td>Tech Hub Setup</td>
                                            <td>Mar 28, 2024</td>
                                            <td>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="request_materials.php" class="btn btn-info">
                                    <i class="fas fa-tools me-2"></i>Request Materials
                                </a>
                            </div>
                        </div>
                    </div>
